...
package io.github.kimmykong.kimmunicator;
 ...
 */
public class Kimmunicator extends CanvasWatchFaceService {
    ...
    private class Engine extends CanvasWatchFaceService.Engine {
        ...
        public void onCreate(SurfaceHolder holder) {
            ...
            setWatchFaceStyle(new WatchFaceStyle.Builder(Kimmunicator.this)
                    .setCardPeekMode(WatchFaceStyle.PEEK_MODE_VARIABLE)
                    .setBackgroundVisibility(WatchFaceStyle.BACKGROUND_VISIBILITY_INTERRUPTIVE)
                    .setShowSystemUiTime(false)
                    .build());
            Resources resources = Kimmunicator.this.getResources();
        ...
        private void registerReceiver() {
            ...
            Kimmunicator.this.registerReceiver(mTimeZoneReceiver, filter);
        }
        ...
        private void unregisterReceiver() {
            ...
            Kimmunicator.this.unregisterReceiver(mTimeZoneReceiver);
        }
        ...
        public void onApplyWindowInsets(WindowInsets insets) {
            ...
            float dateSize = resources.getDimension(isRound
                    ? R.dimen.dateText : R.dimen.digital_text_size);
...
//            String date = String.format("%03s %03s %d %d", mTime.weekDay, mTime.month, mTime.monthDay, mTime.year);
...
//            Log.d("TAG", "textBounds is " + String.valueOf(textBounds.height()));
    ...
    private static class EngineHandler extends Handler {
        private final WeakReference<Kimmunicator.Engine> mWeakReference;

        public EngineHandler(Kimmunicator.Engine reference) {
            mWeakReference = new WeakReference<>(reference);
        }

        @Override
        public void handleMessage(Message msg) {
            Kimmunicator.Engine engine = mWeakReference.get();
            if (engine != null) {
                switch (msg.what) {
